	...
	<div class="inquiry_wrap">
		<form name="inquiry_write" method="post" action="<?=BOARD?>/index.php?<?=$path_action?>" enctype="multipart/form-data" accept-charset="<?=SET?>" class="inquiry_form">
			...
			<fieldset class="iqr_info">
				<legend class="iqr_tit rel b_ff_h">상담자 정보<small class="iqr_dot b_ff_m b_c_l"><span>동그라미 표시</span>는 필수입력항목입니다.</small></legend>
...
?>
						<tr>
							<th scope="row"><label for="iqr_special_03_01" class="special">상담유형</label></th>
							<td class="va_m">
