...
(function($) {
    doc.ready(function() {
        ...
        (function() {
            var bnrMotion = [
                [
					{el: '.sub_line', set: {height: 0}, to: {height: 140}, d: 0.4},
					{el: '.sub_title', set: {opacity: 0, y: 30}, to: {opacity: 1, y: 0}, d: 0.4},
					{el: '.sub_stitle', set: {opacity: 0, y: -30}, to: {opacity: 1, y: 0}, d: 0.4},
                    {el: '.sub_ovl', set: {width: '0'}, to: {width: '100%', ease: Expo.easeIn}, d: 1},
                ]
            ];
        ...
        //서브 상단 배너 >>
        TweenMax.fromTo('.sub_img img', 0.7, {scale:0.9}, {scale:1});
        TweenMax.to('.sub_img1 img', 100, {rotation:360, repeat:-1});
        TweenMax.to('.sub_img3 img', 100, {rotation:360, repeat:-1});
        TweenMax.to('.sub_img4 img', 100, {rotation:360, repeat:-1});
        TweenMax.to('.sub_img5 img', 100, {rotation:360, repeat:-1});
        //서브 상단 배너 <<
    });
    (function() {
       ...
       var $headElems = [$('.sub_visual_video > iframe')],
           player = [],
           playOffset = [],
           stopOffset = [],
           play = [],
