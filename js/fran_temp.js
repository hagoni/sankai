...
(function($) {
    doc.ready(function() {
        ...
        (function () {
			...
			// var happySlide = new Swiper('.happy_slide .swiper-container', {
			// 	slidesPerView: 3,
            //     spaceBetween: 15,
			// 	// allowTouchMove: false,
			// 	pagination: {
		    ...
		    //         renderBullet: function(index, className){
			// 			var pagenum = '';
			// 			var pageindex = index/3+1;
			// 			if(index%3==0 || index == $('.happy_slide .swiper-wrapper > .swiper-slide').size()-3){
			// 				pagenum='pageon';
			// 				if(index == $('.happy_slide .swiper-wrapper > .swiper-slide').size()-3){
			// 					 pageindex = Math.floor(pageindex)+1;
			// 				}
			// 			}
			// 			else{pagenum='pagehide';}
		    //         	return '<li class="' + className + ' ' + pagenum + '"><a href="#none">' + '0' +  pageindex + '</a></li>';
		    //         }
			// 	},
            // });
			// $('.happy_next').click(function () {
			// 	var goindex = (Math.floor(happySlide.activeIndex/3)+1)*3;
			// 	happySlide.slideTo(goindex, 500)
			// });
			// $('.happy_prev').click(function () {
			// 	var goindex = (Math.floor(happySlide.activeIndex/3)-1)*3;
			// 	happySlide.slideTo(goindex, 500)
			// });
