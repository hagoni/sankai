...
?>
	...
	<div class="sub_visual_wrap">
		<div class="sub_visual<?=$gnb_index?> sub_visual rel">
			<p class="sub_title"><img src="<?=$root?>/img/sub/sub_title<?=$gnb_index?>.png" alt="" class="w100"></p>
		</div>
	</div>
	<!-- //sub_visual end -->
	<!-- lnb start -->
	<div class="lnb_wrap swiper-container" id="navigation">
		<ul class="lnb swiper-wrapper">
<?
$depth2_link_query = "SELECT * FROM `".TABLE_LEFT."board` WHERE view3_use_m = '1' AND view3_setup = '$html_idx' AND view3_group_idx = '".$group_list['view3_idx']."' ORDER BY view3_order_m";
$depth2_result = mysql_query($depth2_link_query);
while($depth2_list = mysql_fetch_assoc($depth2_result)) {
...
?>
            <li class="swiper-slide <?if($depth2_list['view3_order_css'] == $minor_index){echo ' on';}?>">
...
?>
	...
	<div class="sub_content" id="content">
		<div class="page_title_area">
			<p class="page_title t_center">
				<?=html_entity_decode($board_list['view3_special_01'])?>
			</p>
			<!-- <p class="page_title"><img src="<?=$root?>/img/sub/page_title1.png" alt="여운을 남기다 넘치는 요리의 자부심" class="w100"></p> -->
		</div>
