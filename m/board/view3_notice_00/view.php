...
$next_command_01 = str_replace('src="/', 'src="'.str_replace('/new','',$pc).'/', html_entity_decode($list['view3_command_01']));
?>
...
$(document).ready(function() {
	if($('.board_view_text').find('iframe').length > 0) new HeightFix($('.board_view_text').find('iframe'), 16, 9);
});
</script>
